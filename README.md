...
1️⃣ Torque-based Optimal Control (FHOCP)
...
2️⃣ PID Parameter Optimization
...
This reduces the optimization problem to only 3 decision variables.
...
rapid convergence to correct orientation
